...
const AllCourses = () => {
  ...
  // Navigate to CourseDetails screen with courseId parameter
...
//     const userInfo = JSON.parse(userInfoString);
//     try {
//       const response = await fetch('http://192.168.33.157:5164/enroll_course', {
//         method: 'POST',
//         headers: {
...
//     } catch (error) {
//       console.error('Error enrolling in course:', error);
//       Alert.alert('Error', 'Failed to enroll in course. Please try again later.');
//     }
//   };
